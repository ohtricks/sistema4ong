<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li>Doadores</li>
			<li class="active">Cadastro de Doadores</li>
		</ol>
	</section>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="tel" class="form-control" id="telefone"
											name="telefone" placeholder="Informe o telefone comercial" value="<?php echo set_value('telefone'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="tel" class="form-control" id="celular"
											name="celular" placeholder="Informe o telefone celular" value="<?php echo set_value('celular'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="email" class="form-control" id="email"
											name="email" placeholder="Informe o E-mail" value="<?php echo set_value('email'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="endereco"
											name="endereco" placeholder="Informe o Endereço" value="<?php echo set_value('endereco'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="complemento"
											name="complemento" placeholder="Informações complementares" value="<?php echo set_value('complemento'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="bairro"
											name="bairro" placeholder="Informe o Bairro" value="<?php echo set_value('bairro'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="cidade"
											name="cidade" placeholder="Informe a Cidade" value="<?php echo set_value('cidade'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="estado"
											name="estado" placeholder="Informe o Estado" value="<?php echo set_value('estado'); ?>">	
									</div>
								</div>
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="cep"
											name="cep" placeholder="Informe o CEP" value="<?php echo set_value('cep'); ?>">	
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-3 col-lg-3">
									<button type="submit" class="btn btn-primary"
										style="width: 100%">Cadastrar Doador</button>
								</div>
							</div>
						</form>
					</div>
