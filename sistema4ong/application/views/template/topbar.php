...
<!--         <span class="logo-mini"><b>Sistema </b>YouTUBE</span> -->
        <span class="logo-mini"><img src="../assets/img/avatar11.jpeg" style="width: 48px; height: 48px"></span>


        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Sistema </b>4ONG</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="../assets/img/avatar1.jpg" class="img-circle" alt="User Image">
                                        </div>
                                        <h4>
                                            Support Team
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="../assets/img/avatar1.jpeg" class="user-image" alt="User Image">
