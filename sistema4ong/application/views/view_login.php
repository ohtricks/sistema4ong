...
<head>
  ...
  <title>Sistema 4ONG | Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Sistema </b>4ONG</a>
  </div>
  <!-- /.login-logo -->
    ...
    ?>
      <div class="form-group has-feedback">
        <?php echo form_error('username'); ?>
          <input type="text" name="login" placeholder="Digite seu login" id="login" value="<?php echo set_value('login'); ?>" size="50" />
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
          <?php echo form_error('password'); ?>
          <input type="password" name="senha" placeholder="Digite sua senha" id="senha" value="" size="50" />
